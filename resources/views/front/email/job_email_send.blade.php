...
<body>
    ...
    <!--*|END:IF|*-->
    <center>
        <table width="600" align="center" border="1" style="border:1px solid #cccccc;" cellpadding="0" cellspacing="0"
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td align="center" valign="top" id="templateHeader" data-template-container
                                style="background-color:#1E326F; padding: 30px 0px;">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td class="mcnImageContent"
                                                                            ...
                                                                            valign="top">
                                                                            <img alt=""
                                                                                src="{{ asset('front/images/logo-white.png') }}"
                                                                                style="padding-bottom: 0; display: inline !important; vertical-align: bottom;"
                                                                                class="mcnImage" width="300"
                                                                                height="78" align="middle">
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                        ...
                        <tr>
                            <td align="center" valign="top" id="templateBody" data-template-container>
                                <table align="center" border="0" cellpadding="0" cellspacing="0" max-width="100%"
                                    class="templateContainer" style="padding-bottom: 30px;">
                                    <tr>
                                        <td valign="top" class="bodyContainer">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td class="mcnTextContent"
                                                                            style="padding-top:0; padding-right:30px; padding-bottom:9px; padding-left:30px;"
                                                                            valign="top">
                                                                            <h3 class="null"
                                                                                style="text-align: left;">Hi Admin,</h3>
                                                                            <p><span
                                                                                    style="color:#585858; font-family:arial,sans-serif; font-size:9.0pt">You
                                                                                    have received one contact request
                                                                                    form information. Details are
                                                                                    below.</span></p>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                            ...
                                            <table class="mcnImageBlock" style="min-width:100%;" width="100%"
                                                ...
                                                <tbody class="mcnImageBlockOuter">
                                                    <tr>
                                                        <td style="padding:9px 30px 9px 30px;"
                                        ...
                                        <td valign="top" class="footerContainer">
                                            <table class="mcnFollowBlock" style="min-width:100%;" width="100%"
                                                ...
                                                <tbody class="mcnFollowBlockOuter">
                                                    <tr>
                                                        <td style="padding:9px" class="mcnFollowBlockInner" valign="top"
                                                            align="center">
                                                                                                                                                    ...
                                                                                                                                                    <tr>
                                                                                                                                                        <td class="mcnFollowIconContent"
                                                                                                                                                            ...
                                                                                                                                                            <a href="https://www.facebook.com/ExpertAppDevs"
                                                                                                                                                                target="_blank"><img
                                                                                                                                                                    src="{{ asset('front/images') }}/outline-light-facebook-48.png"
                                                                                                                                                                    style="display:block;"
                                                                                                                                                                    class=""
                                                                                                                                                                    width="24"
                                                                                                                                                                    height="24"></a>
                                                                                                                                                        ...
                                                                                                                                                        <td class="mcnFollowIconContent"
                                                                                                                                                            ...
                                                                                                                                                            <a href="https://www.instagram.com/expertappdevs/"
                                                                                                                                                                target="_blank"><img
                                                                                                                                                                    src="{{ asset('front/images') }}/outline-light-instagram-48.png"
                                                                                                                                                                    style="display:block;"
                                                                                                                                                                    class=""
                                                                                                                                                                    width="24"
                                                                                                                                                                    height="24"></a>
                                                                                                                                                        ...
                                                                                                                                                        <td class="mcnFollowIconContent"
                                                                                                                                                            ...
                                                                                                                                                            <a href="https://twitter.com/ExpertAppDevs"
                                                                                                                                                                target="_blank"><img
                                                                                                                                                                    src="{{ asset('front/images') }}/outline-light-twitter-48.png"
                                                                                                                                                                    style="display:block;"
                                                                                                                                                                    class=""
                                                                                                                                                                    width="24"
                                                                                                                                                                    height="24"></a>
                                                                                                                                                        ...
                                                                                                                                                        <td class="mcnFollowIconContent"
                                                                                                                                                            ...
                                                                                                                                                            <a href="https://www.linkedin.com/company/expert-app-devs/"
                                                                                                                                                                target="_blank"><img
                                                                                                                                                                    src="{{ asset('front/images') }}/outline-light-linkedin-48.png"
                                                                                                                                                                    style="display:block;"
                                                                                                                                                                    class=""
                                                                                                                                                                    width="24"
                                                                                                                                                                    height="24"></a>
                                                                    ...
                                                                    <tr>
                                                                        <td class="mcnTextContent"
                                                                            ...
                                                                            <div style="text-align: center;">
                                                                                <div class="contact_detail"><a
                                                                                        href="{{ route('home') }}"
                                                                                        style="color: #fff; text-decoration:none;">www.expertappdevs.com</a>
                                                                                </div>
                                                                                <br>
                                                                                <div class="contact_detail"><span
                                                                                        style="color: #fff;">735, Iscon
                                                                                        Emporio, Beside Star Bazaar,
                                                                                        Satellite, Ahmedabad, Gujarat
                                                                                        380015, India</span></div>
                                                                                <div class="contact_detail"
                                                                                    style="color: #fff;"><span><a
                                                                                            href="tel:+917016166822"
                                                                                            style="color: #FFFFFF;text-decoration: none;">+91
                                                                                            701-616-6822</a>&nbsp;&nbsp;&nbsp;
                                                                                        | &nbsp; <a href="mailto:"
                                                                                            style="color: #FFFFFF;text-decoration: none;">
                                                                                            job@expertappdevs.com</a></span><br><br>
                                                                                    © {{ date('Y') }} Expert App
                                                                                    Devs</div>
                                                                                <div class="contact_detail">
                                                                                    &nbsp;</div>
