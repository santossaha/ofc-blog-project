...
<div class="kt-subheader  kt-grid__item" id="kt_subheader">
    <div class="kt-container  kt-container--fluid ">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">@if(isset($edit)) Edit @else Add New @endif Blog Category</h3>
        </div>
        <div class="kt-subheader__toolbar">
            <a href="{{route('admin.blogcategory.index')}}" class="btn btn-default btn-bold"><i class="fa fa-arrow-left"></i> Back</a>
        </div>
    </div>
</div>
<!-- end:: Content Head -->
...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    ...
    <div class="kt-portlet kt-portlet--mobile">
        <div class="kt-portlet__body">
            <form method="POST" id="blogcategory" enctype="multipart/form-data" action="{{route('admin.blogcategory.store')}}" class="kt-form kt-form--label-right" _lpchecked="1">
                @csrf
                @if(isset($edit))
                 ...
                 <div class="kt-portlet__body">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-6">
                            ...
                            <textarea class="form-control" placeholder="Enter meta description" name="meta_description">{{ (isset($edit)) ? $edit->meta_description : old('meta_description') }}</textarea>
...
<script src="{{ asset('front/js/validate.js') }}"></script>
    <script type="application/javascript">
        $(function() {
            $("#blogcategory").submit(function(e) {
                e.preventDefault();
            }).validate({
                rules: {
                    meta_description: {
