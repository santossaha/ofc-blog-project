        ...
        <div class="kt-portlet__body kt-portlet__body--fit-y">
            <div class="kt-widget kt-widget--user-profile-1">
                <div class="kt-widget__head">
                    <div class="kt-widget__content">
                        <div class="kt-widget__section">
                            <a href="{{route('admin.profile.index')}}" class="kt-widget__username">
                                {{Auth::user()->name}}
                ...
                <div class="kt-widget__body">
                    <div class="kt-widget__content">
                        <div class="kt-widget__info" style="justify-content:start;">
                            <span class="kt-widget__label mr-2">Email :</span>
                            <a href="{{route('admin.profile.index')}}" class="kt-widget__data">{{isset(Auth::user()->email) ? Auth::user()->email : '-'}}</a>
                        </div>
                    </div>
                    <div class="kt-widget__items">
                        <a href="{{route('admin.profile.index')}}" class="kt-widget__item {{ activeWidgetMenu('admin/profile') }}">
                        ...
                        <a href="{{route('admin.profile.changepassword')}}" class="kt-widget__item {{ activeWidgetMenu('admin/profile/changepassword') }}">
                            <span class="kt-widget__section">
                                <span class="kt-widget__icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
