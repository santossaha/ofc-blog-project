...
<x-layout.create title="Add New Technology" :action="$action" :backroute="route('admin.technology.index')">
    <x-form.input name="title" lable="Title *" :value="__(old('title'))"/>

    <x-form.input name="slug" lable="Slug" :value="__(old('slug'))"/>

    <x-form.input name="short_title" lable="Short Title" :value="__(old('short_title'))"/>
    ...
    <x-form.input name="hire_us_title" lable="Hire Us Title" :value="__(old('hire_us_title'))"/>
    <x-form.input name="stories_title" lable="Success Stories Title" :value="__(old('stories_title'))"/>
    <x-form.input name="customer_title" lable="Customer Says Title" :value="__(old('customer_title'))"/>
    <x-form.input name="insight_title" lable="Insight Title" :value="__(old('insight_title'))"/>
